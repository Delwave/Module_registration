    ...
    while True:                                                                            # Бесконечный цикл для ввода пользователей
        ...
        if choice == '2':                                                                  # Если выбрано вход
            ...
            if login in database_try.data:                                                 # Если пользователь существует в базе данных
                if password == database_try.data[login]:                                   # Если пароли совпадают в базе данных
                    print(f'Вход {login} успешен!')
                    break
                else:
                    print('Неверный пароль!')                                              # Выводим сообщение об ошибке
            else:
                print('Пользователь не найден!')                                           # Выводим сообщение об ошибке
